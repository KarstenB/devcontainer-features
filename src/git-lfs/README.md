...
```json
"features": {
    "ghcr.io/KarstenB/devcontainer-features/git-lfs:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/KarstenB/devcontainer-features/blob/main/src/git-lfs/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
